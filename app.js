...
document.addEventListener('DOMContentLoaded', () => {
  ...
  /* ==========================================
     7. Auth Modal System (Sign In / Register)
     ========================================== */
  ...
  if (loginFormEl) {
    loginFormEl.addEventListener('submit', (e) => {
      ...
      const submitBtn = loginFormEl.querySelector('.btn-submit');
      const btnText = submitBtn.querySelector('.btn-text');
      const btnSpinner = submitBtn.querySelector('.btn-spinner');

      // Play loading spinner animation
      ...
      setTimeout(() => {
        ...
        // Hide signin buttons, show welcome user profile menu
        signinTriggers.forEach(btn => btn.classList.add('hidden'));
        
        const username = email.split('@')[0];
        const formattedName = username.charAt(0).toUpperCase() + username.slice(1);
        userDisplayName.textContent = formattedName;
        userAvatarInitials.textContent = formattedName.substring(0, 2).toUpperCase();
  ...
  if (registerFormEl) {
    registerFormEl.addEventListener('submit', (e) => {
      ...
      const submitBtn = registerFormEl.querySelector('.btn-submit');
      const btnText = submitBtn.querySelector('.btn-text');
      const btnSpinner = submitBtn.querySelector('.btn-spinner');
      ...
      setTimeout(() => {
        ...
        userAvatarInitials.textContent = name.split(' ').map(n => n[0]).join('').substring(0, 2).toUpperCase();
  ...
  if (btnLogout) {
    btnLogout.addEventListener('click', () => {
      ...
      signinTriggers.forEach(btn => btn.classList.remove('hidden'));
    });
  }
